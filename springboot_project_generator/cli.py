...
def build_parser():
    ...
    generate.add_argument("--project-name", required=True)
    ...
    generate.add_argument("--spring-boot-version", default="3.3.5")
    generate.add_argument("--mybatis-plus-version", default="3.5.7")
    generate.add_argument("--jwt-version", default="0.12.6")
...
def build_options(args):
    ...
    return ProjectOptions(
        ...
        mybatis_plus_version=args.mybatis_plus_version,
        jwt_version=args.jwt_version,
    )
